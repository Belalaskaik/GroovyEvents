<script>
    ...
    async function registerClub() {
      ...
      formData.append('members', membersNumber.toString()); // Convert back to string if necessary
  ...
  <form on:submit|preventDefault={registerClub}>
    ...
    <NeonTextInput placeholder="Contact Email" bind:value={club.email} />
    <NeonTextInput placeholder="Number of Members" bind:value={club.members} />
    ...
    <NeonButton text="Register Club" on:click={registerClub}/>
  </form>
